...
bool operator==(const ::pal_detection_msgs::AddTexturedObjectResponse_<ContainerAllocator1> & lhs, const ::pal_detection_msgs::AddTexturedObjectResponse_<ContainerAllocator2> & rhs)
{
...
struct Definition< ::pal_detection_msgs::AddTexturedObjectResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "bool result               # The result will be true if the texture_detector node has been\n"
