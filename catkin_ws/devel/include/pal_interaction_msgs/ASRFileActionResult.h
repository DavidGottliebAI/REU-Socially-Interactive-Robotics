...
bool operator==(const ::pal_interaction_msgs::ASRFileActionResult_<ContainerAllocator1> & lhs, const ::pal_interaction_msgs::ASRFileActionResult_<ContainerAllocator2> & rhs)
{
