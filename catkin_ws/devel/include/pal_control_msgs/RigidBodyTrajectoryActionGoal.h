...
bool operator==(const ::pal_control_msgs::RigidBodyTrajectoryActionGoal_<ContainerAllocator1> & lhs, const ::pal_control_msgs::RigidBodyTrajectoryActionGoal_<ContainerAllocator2> & rhs)
{
