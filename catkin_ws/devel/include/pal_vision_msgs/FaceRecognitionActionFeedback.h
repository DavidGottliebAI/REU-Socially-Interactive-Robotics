...
bool operator==(const ::pal_vision_msgs::FaceRecognitionActionFeedback_<ContainerAllocator1> & lhs, const ::pal_vision_msgs::FaceRecognitionActionFeedback_<ContainerAllocator2> & rhs)
{
