...
bool operator==(const ::pal_vision_msgs::FaceRecognitionAction_<ContainerAllocator1> & lhs, const ::pal_vision_msgs::FaceRecognitionAction_<ContainerAllocator2> & rhs)
{
