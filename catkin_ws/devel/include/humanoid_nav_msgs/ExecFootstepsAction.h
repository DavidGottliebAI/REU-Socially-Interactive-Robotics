...
bool operator==(const ::humanoid_nav_msgs::ExecFootstepsAction_<ContainerAllocator1> & lhs, const ::humanoid_nav_msgs::ExecFootstepsAction_<ContainerAllocator2> & rhs)
{
