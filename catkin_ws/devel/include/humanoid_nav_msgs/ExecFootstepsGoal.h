...
bool operator==(const ::humanoid_nav_msgs::ExecFootstepsGoal_<ContainerAllocator1> & lhs, const ::humanoid_nav_msgs::ExecFootstepsGoal_<ContainerAllocator2> & rhs)
{
  return lhs.footsteps == rhs.footsteps &&
    lhs.feedback_frequency == rhs.feedback_frequency;
}
