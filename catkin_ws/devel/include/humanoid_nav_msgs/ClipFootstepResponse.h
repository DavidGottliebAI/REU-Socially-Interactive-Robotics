...
bool operator==(const ::humanoid_nav_msgs::ClipFootstepResponse_<ContainerAllocator1> & lhs, const ::humanoid_nav_msgs::ClipFootstepResponse_<ContainerAllocator2> & rhs)
{
