...
bool operator==(const ::humanoid_nav_msgs::ExecFootstepsActionFeedback_<ContainerAllocator1> & lhs, const ::humanoid_nav_msgs::ExecFootstepsActionFeedback_<ContainerAllocator2> & rhs)
{
