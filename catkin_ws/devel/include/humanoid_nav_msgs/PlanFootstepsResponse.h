// Generated by gencpp from file humanoid_nav_msgs/PlanFootstepsResponse.msg
// DO NOT EDIT!


#ifndef HUMANOID_NAV_MSGS_MESSAGE_PLANFOOTSTEPSRESPONSE_H
#define HUMANOID_NAV_MSGS_MESSAGE_PLANFOOTSTEPSRESPONSE_H
...
std::ostream& operator<<(std::ostream& s, const ::humanoid_nav_msgs::PlanFootstepsResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::humanoid_nav_msgs::PlanFootstepsResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::humanoid_nav_msgs::PlanFootstepsResponse_<ContainerAllocator1> & lhs, const ::humanoid_nav_msgs::PlanFootstepsResponse_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::humanoid_nav_msgs::PlanFootstepsResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::humanoid_nav_msgs::PlanFootstepsResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::humanoid_nav_msgs::PlanFootstepsResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::humanoid_nav_msgs::PlanFootstepsResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::humanoid_nav_msgs::PlanFootstepsResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::humanoid_nav_msgs::PlanFootstepsResponse_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::humanoid_nav_msgs::PlanFootstepsResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::humanoid_nav_msgs::PlanFootstepsResponse_<ContainerAllocator>& v)
  {
    s << indent << "result: ";
...
#endif // HUMANOID_NAV_MSGS_MESSAGE_PLANFOOTSTEPSRESPONSE_H
