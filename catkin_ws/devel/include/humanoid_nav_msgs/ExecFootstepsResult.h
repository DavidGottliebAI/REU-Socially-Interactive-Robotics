...
bool operator==(const ::humanoid_nav_msgs::ExecFootstepsResult_<ContainerAllocator1> & lhs, const ::humanoid_nav_msgs::ExecFootstepsResult_<ContainerAllocator2> & rhs)
{
