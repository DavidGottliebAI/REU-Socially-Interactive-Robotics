...
bool operator==(const ::pal_device_msgs::TimedFadeEffectResponse_<ContainerAllocator1> & lhs, const ::pal_device_msgs::TimedFadeEffectResponse_<ContainerAllocator2> & rhs)
{
