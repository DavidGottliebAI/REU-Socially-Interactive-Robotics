...
bool operator==(const ::pal_device_msgs::TimedBlinkEffectResponse_<ContainerAllocator1> & lhs, const ::pal_device_msgs::TimedBlinkEffectResponse_<ContainerAllocator2> & rhs)
{
