...
bool operator==(const ::pal_navigation_msgs::JoyPriorityActionGoal_<ContainerAllocator1> & lhs, const ::pal_navigation_msgs::JoyPriorityActionGoal_<ContainerAllocator2> & rhs)
{
