...
bool operator==(const ::pal_visual_localization_msgs::VisualLocAddPlaceActionGoal_<ContainerAllocator1> & lhs, const ::pal_visual_localization_msgs::VisualLocAddPlaceActionGoal_<ContainerAllocator2> & rhs)
{
